...
import com.emsbackend.ems_backend.exception.ResourceNotFountException;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public EmployeeDto getEmployeeById(Long employeeId) {
        Employee employee = employeeRepository.findById(employeeId)
                .orElseThrow(()->new ResourceNotFountException("Employee does not exist with this id" + employeeId));
    ...
    public EmployeeDto updateEmployee(Long employeeId, EmployeeDto updatedEmployee) {
        Employee employee = employeeRepository.findById(employeeId).orElseThrow(
                ()-> new ResourceNotFountException("Employee does not exist with this id" + employeeId)
        );
